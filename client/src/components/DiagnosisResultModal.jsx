      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            {icon}
            <span style={{ fontSize: "15px", fontWeight: 700, color: t.title }}>
              {title}
            </span>
          </div>
          {isOpen ? (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              ...
              >
                CropCare AI • Disease Result & Advisory
              </h2>
              <p
                style={{
                  fontSize: "13px",
              ...
              >
                Comprehensive single-window agronomic report
              </p>
            </div>
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <button
              type="button"
              aria-label="Switch advisory language"
            ...
            <button
              ...
              aria-label={
                isSpeaking ? "Stop audio readout" : "Listen to audio readout"
              }
              style={{
                display: "flex",
                alignItems: "center",
        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: "260px", position: "relative" }}>
              ...
              >
                <AlertTriangle size={15} /> Severity: {severity}/5 (
                {activeDiagnosis.severityLabel ||
                  (severity >= 4
                    ? "Severe"
                    : severity >= 3
                      ? "Moderate"
          ...
          <div style={{ padding: "32px 24px" }}>
            ...
            >
              ...
              <span style={{ fontSize: "13.5px", color: "#64748b" }}>
                Detailed guidance for better crop health
              </span>
            </div>
              ...
              <div style={{ display: "flex", flexDirection: "column" }}>
                  ...
                  {symptomsList.length > 0 ? (
                    ...
                    <div style={{ fontSize: "14px", color: "#475569" }}>
                      {activeDiagnosis.simpleExplanation ||
                        "Observable discoloration and characteristic lesion patterns on leaves and foliage."}
                    </div>
                  )}
                </AccordionCard>
                ...
                >
                  ...
                  {activeDiagnosis.vector && (
                    ...
                    >
                      <strong>Vector / Causative Agent:</strong>{" "}
                      {activeDiagnosis.vector}
                    </div>
                  )}
                </AccordionCard>
                ...
                >
                  ...
                  >
                    {activeDiagnosis.chemicalRemedy ||
                      ...
                      "Apply target chemical fungicide/insecticide per label instructions."}
                  </div>
                </AccordionCard>
              </div>
                ...
                >
                  ...
                  >
                    {activeDiagnosis.organicRemedy ||
                      activeDiagnosis.organic_alternative ||
                      "Spray pure cold-pressed Neem Oil (3000 ppm) @ 5 ml per 1 Litre water with 1 ml liquid soap."}
                  </div>
                </AccordionCard>
                ...
                >
                  ...
                  >
                    {activeDiagnosis.culturalTips ||
                      ...
                      "Maintain clean field bunds, proper plant spacing, avoid excessive nitrogen, and ensure clean water drainage."}
                  </div>
                </AccordionCard>
              </div>
            </div>
              ...
              <div>
                ...
                >
                  {activeDiagnosis.immediateAction ||
                    "Carefully remove the infected galls by hand before they burst and bury them deep in the soil or burn them to prevent spore spread."}
                </p>
              </div>
            </div>
            ...
            >
              ...
              >
                Have doubts about spray dosage, water volume, or organic mixing?
                Ask Crop Doctor AI directly:
              </span>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              fontSize: "14px",
              cursor: "pointer",
              boxShadow: "0 4px 12px rgba(33, 130, 91, 0.2)",
            }}
          >
